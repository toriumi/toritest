/**
 * @file      output_disp_opencv_wnd.h
 * @brief     OpenCV displaying window.
 * @author    Vision Processing Community
 * @copyright 2016 Vision Processing Community. All rights reserved.
 */
#ifndef _OUTPUT_DISP_OPENCV_WND_H_
#define _OUTPUT_DISP_OPENCV_WND_H_
 ...
 * @brief OpenCV displaying window.
 */
class OutputDispOpencvWnd : public wxFrame {
 private:
 ...
 public:
   ...
   */
  explicit OutputDispOpencvWnd(OutputDispOpencv* owner_plugin);

  /**
   * @brief
   * Destructor for this window.
   */
  virtual ~OutputDispOpencvWnd(void);
...
#endif /* _OUTPUT_DISP_OPENCV_WND_H_*/
